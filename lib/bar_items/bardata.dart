...
class BarData {
  ...
  final double fri;
  final double sat;
  BarData({required this.sun, required this.mon, required this.tue, required this.wed, required this.thu, required this.fri, required this.sat});
  List<IndividualBar> bars = [];

  void initilizedBarData(){
    bars = [
